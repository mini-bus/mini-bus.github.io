...
window.onload = function() {
  ...
  //vars
  var tracker = 0;
  var slidewindow = document.querySelector("#slideshow #slidewindow");
  var slides = document.querySelectorAll("#slideshow #slidewindow div");
  var next = document.querySelector("#slideshow #controls #next");
  var prev = document.querySelector("#slideshow #controls #prev");
  var dots = document.querySelector("#slideshow #controls #dots");
  var allDots = document.querySelectorAll("LI");
